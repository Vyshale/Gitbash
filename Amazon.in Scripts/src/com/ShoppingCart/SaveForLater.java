...
public class SaveForLater {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Boolean empty =driver.findElement(By.xpath("//h2[contains(text(),' Your Amazon Cart is empty.')]")).isDisplayed();
		Boolean empty = driver.findElement(By.xpath("//div[@class='a-row sc-cart-header sc-compact-bottom']")).isDisplayed();
